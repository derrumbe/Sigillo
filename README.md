...
| **Exposure** | Tap the EV chip to reveal a radial exposure-compensation dial; drag around the arc to set the value. The dial auto-hides a few seconds after the last adjustment. |
